...
<svg height="171.4" width="400" viewBox="0 0 400 171.4">
	...
	<g mask="url(#mapMask)" filter="url(#blur)">
		...
		<circle cx="0" cy="0" r="30" fill="url(#grad)" filter="brightness(172%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="39.3s" begin="-23.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="21.4s" begin="-20s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="14" fill="url(#grad)" filter="brightness(131%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="39.7s" begin="-16.5s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="21.2s" begin="-19.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="6" fill="url(#grad)" filter="brightness(123%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.5s" begin="-7.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="20.9s" begin="-11.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="17" fill="url(#grad)" filter="brightness(194%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="37s" begin="-28.7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="35s" begin="-7.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="27" fill="url(#grad)" filter="brightness(173%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="35.5s" begin="-23.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="31.9s" begin="-18.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="19" fill="url(#grad)" filter="brightness(216%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="34.8s" begin="-35.7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="34.3s" begin="-12.8s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="8" fill="url(#grad)" filter="brightness(187%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38s" begin="-18.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="24.5s" begin="-6.1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="7" fill="url(#grad)" filter="brightness(204%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="32.9s" begin="-18.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="20.9s" begin="-9.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="22" fill="url(#grad)" filter="brightness(243%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="35s" begin="-33.1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="26.4s" begin="-16.7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="28" fill="url(#grad)" filter="brightness(145%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="33.4s" begin="-15s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="24.5s" begin="-20s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="21" fill="url(#grad)" filter="brightness(210%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.8s" begin="-18s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="32.6s" begin="-16.8s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="9" fill="url(#grad)" filter="brightness(208%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="33s" begin="-14.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="20s" begin="-9.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="8" fill="url(#grad)" filter="brightness(247%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="36.6s" begin="-33.7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="22.5s" begin="-10.1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="26" fill="url(#grad)" filter="brightness(105%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="30.2s" begin="-4.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="34.1s" begin="-17.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="12" fill="url(#grad)" filter="brightness(239%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.8s" begin="-29.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="32.4s" begin="-9.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="5" fill="url(#grad)" filter="brightness(182%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="31.8s" begin="-24.8s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="21.7s" begin="-11.8s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="17" fill="url(#grad)" filter="brightness(220%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.2s" begin="-16.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="32.9s" begin="-19s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="14" fill="url(#grad)" filter="brightness(205%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="32.8s" begin="-23.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="21.5s" begin="-11.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="25" fill="url(#grad)" filter="brightness(163%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="39.2s" begin="-5.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="28.9s" begin="-19.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="9" fill="url(#grad)" filter="brightness(155%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="39.4s" begin="-34.5s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="30.5s" begin="-15.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="11" fill="url(#grad)" filter="brightness(200%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="39.2s" begin="-32.7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="24.8s" begin="-7.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="29" fill="url(#grad)" filter="brightness(192%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="33.7s" begin="-23.9s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="32.9s" begin="-17.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="18" fill="url(#grad)" filter="brightness(137%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.1s" begin="-15.1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="32s" begin="-7s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="25" fill="url(#grad)" filter="brightness(164%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="30.5s" begin="-8.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="21.4s" begin="-18.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="24" fill="url(#grad)" filter="brightness(110%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="30.8s" begin="-17.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="28.8s" begin="-9.3s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="28" fill="url(#grad)" filter="brightness(117%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="33.2s" begin="-25.1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="26.1s" begin="-18.6s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="28" fill="url(#grad)" filter="brightness(168%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="38.8s" begin="-0.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="30.3s" begin="-5.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="7" fill="url(#grad)" filter="brightness(245%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="37.5s" begin="-36.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="30.6s" begin="-18.4s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="8" fill="url(#grad)" filter="brightness(232%)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="34.8s" begin="-36.5s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="30.3s" begin="-9.2s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
		<circle cx="0" cy="0" r="11" fill="url(#grad)" filter="brightness(2.2)">
			<animate attributeName="cx" values="0%; 100%; 0%" dur="35.8s" begin="-1s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
			<animate attributeName="cy" values="0%; 100%; 0%" dur="23.1s" begin="-19.8s" repeatCount="indefinite" keyTimes="0;0.5;1" keySplines="0.13 0.5 0.87 0.5; 0.13 0.5 0.87 0.5" calcMode="spline" />
		</circle>
	</g>
</svg>
